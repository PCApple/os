...
//ATAPI Commands (I dont think ill use these)
#define      ATAPI_CMD_READ       0xA8
#define      ATAPI_CMD_EJECT      0x1B

//ATA_CMD_IDENTIFY returns this in the buffer
...
// BARs
#define ATA_PRIMARY_CMD_BASE     0x1F0 // BAR0
#define ATA_PRIMARY_CTRL_BASE    0x3F6 // BAR1
